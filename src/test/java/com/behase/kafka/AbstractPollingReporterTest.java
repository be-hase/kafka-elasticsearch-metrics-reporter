...
public abstract class AbstractPollingReporterTest {
	...
	protected abstract AbstractPollingReporter createReporter(MetricsRegistry registry, OutputStream out, Clock clock)
			throws Exception;
	...
	static Counter createCounter(long count) throws Exception {
		...
		return configureMatcher(mock, doAnswer(new MetricsProcessorAction() {
			@Override
			void delegateToProcessor(MetricProcessor<Object> processor, MetricName name, Object context)
					throws Exception {
	...
	static abstract class MetricsProcessorAction implements Answer<Object> {
		...
		abstract void delegateToProcessor(MetricProcessor<Object> processor, MetricName name, Object context)
				throws Exception;
	}
